...
#include "mtmsl_common/controlInfo.h"
#include "mtmsl_common/teleop.h"
#include "mtmsl_common/position.h"
#include "mtmsl_common/obstacle.h"
#include "mtmsl_common/requestKick.h"

using namespace ros;
using mtmsl_common::robotInfo; //Namespace for robot information msg - PUBLISHING
using mtmsl_common::controlInfo; //Namespace for control information msg - SUBSCRIBING
using mtmsl_common::teleop; //Namespace for teleop information msg - SUBSCRIBING
using mtmsl_common::requestKick; // Namespace for kicking service
...
namespace gazebo
{
  ...
  class Minho_Robot : public ModelPlugin
  {
    ...
    std::vector<mtmsl_common::obstacle>detectObstacles();
